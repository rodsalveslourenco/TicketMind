...
export const defaultPermissionCatalog = [
  ...
  },
  {
    ...
    label: "Técnicos",
    description: "Acompanhamento de performance e carga dos técnicos.",
    order: 30,
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "tickets_assign", label: "Atribuir técnico", action: "assign" },
...
export const defaultNavigationSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/helpdesk-technicians", label: "Painel técnico", module: "helpdesk_technicians", icon: "helpdesk_technicians" },
...
export const defaultNotificationEvents = [
  ...
  { key: "ticket_approval_overdue", label: "Aprovação atrasada", description: "Enviado quando o SLA da aprovação é violado." },
  { key: "ticket_approval_reminder", label: "Lembrete recorrente de aprovação", description: "Enviado periodicamente enquanto a aprovação estiver pendente, mesmo sem nova atividade no chamado." },
];

export const defaultEmailPlaceholders = [
  { key: "numero_chamado", label: "Número do chamado" },
  ...
  { key: "sla_aprovacao", label: "SLA de aprovação" },
  ...
  { key: "ia_acoes", label: "Ações recomendadas pela IA" },
];

...
const FIELD_LABELS = {
  ...
  serviceCenter: "central de servicos",
  navigationSections: "menus e navegacao",
  active: "ativo",
  acceptsTickets: "aceita chamados",
  showInRequestPortal: "exibir no portal",
  responsibleUserIds: "responsaveis vinculados",
...
const MODULE_LABELS = {
  ...
  central_servicos: "Central de Servicos",
  chamados: "Chamados",
